...
class PeliculaAdapter: BaseAdapter {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val ivImagenPelicula = vista.findViewById<ImageView>(R.id.ivimagenpelicula)
        val tvNombrePelicula = vista.findViewById<TextView>(R.id.tvnombrepelicula)

        ivImagenPelicula.setImageResource(pelicula.image)
        tvNombrePelicula.setText(pelicula.titulo)

        ivImagenPelicula.setOnClickListener{
